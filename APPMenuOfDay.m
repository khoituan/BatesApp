...
#import "APPMenuOfDay.h"

@interface APPMenuOfDay ()
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Set up the cell
    int indexRow = (indexPath.row + start[_daySelected]) % [_ans count];
    cell.textLabel.text = [_ans objectAtIndex:indexRow];
